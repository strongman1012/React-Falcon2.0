...
function SearchScanReason() {
  ...
  const initPageModule = async () => {
    try {
      ...
      const ep = endpoint.getDataQuickScanReasonSchemaEndpoint('search');
    ...
    <>
      ...
      <Row className="mx-4 mt-3">
        <Col xs={24} md={24} lg={23}>
          ...
          <Text strong>Free text search</Text>
          <Input
...
export default SearchScanReason;
