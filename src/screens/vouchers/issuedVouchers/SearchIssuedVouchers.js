...
function SearchIssuedVouchers() {
  ...
  const initPageModule = async () => {
    try {
      ...
      const ep = endpoint.getDataIssuedVoucherSchemaEndpoint('search');
      ...
      <Row className="mx-4 mt-3">
        <Col span={24}>
          <Title level={4} className="mb-3">
            Search vouchers issued records
          </Title>
        </Col>
      </Row>
      <Row className="mx-4 mt-3">
...
export default SearchIssuedVouchers;
