...
function CsvBranches() {
  ...
  const initPageModule = async () => {
    try {
      ...
      const ep = endpoint.getDataBrancheSchemaEndpoint('csv');
    ...
    <>
      <Row className="mx-4 mt-5">
        ...
        <Col xs={1} lg={4} style={{ textAlign: 'end' }}>
          <Tooltip
            title="Import data from CSV/Excel fileImport multiple entries by using the CSV file located below. Click on the 'Get CSV' button and save the CSV file to your desktop. Once you have added all the data browse to the file and use the 'Upload CSV' button to import it."
            placement="bottom"
          >
