...
function SearchBranches() {
  ...
  const initPageModule = async () => {
    try {
      ...
      const ep = endpoint.getDataBrancheSchemaEndpoint(`${routeKey}`);
    ...
    <>
      <Row className="mx-4 mt-3">
        <Col xs={24} md={24} lg={23}>
          <Paragraph>
            The 'branches/stores' module allows you to add multiple stores or
            branches to your account. Please feel free to evaluate this module,
            however it is an premium feature and will require upgrade to our
            Gold Subscription if used for more than 30 days.
          </Paragraph>
        </Col>
      </Row>
