...
import { Typography, Row, Col, Upload, Tooltip } from 'antd';
...
function TransactionPromotionsCSV() {
  ...
  //     const ep = endpoint.getPromotionsDataManagerSchemaEndpoint('csv');
...
export default TransactionPromotionsCSV;
